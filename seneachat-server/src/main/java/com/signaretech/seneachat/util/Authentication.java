...
//		String hashCode = auth.hash(new String("password").toCharArray());

//		Boolean authResult = auth.authenticate(new String("password").toCharArray(), hashCode);
//		System.out.println("Authentication result is: " + authResult);
//	}
